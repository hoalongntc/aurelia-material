...
export class App {
  configureRouter(config, router) {
    ...
    config.map([
      ...
      { route: 'form-elements', name: 'form-elements', moduleId: 'components/form/elements',
        nav: true, title: 'Form Elements'},
      { route: 'form-components', name: 'form-components', moduleId: 'components/form/components',
        nav: true, title: 'Form Components'},
      { route: 'form-examples', name: 'form-examples', moduleId: 'components/form/examples',
        nav: true, title: 'Form Examples'},
      { route: 'form-validations', name: 'form-validations', moduleId: 'components/form/validations',
        nav: true, title: 'Form Validations'}
    ]);
